  ...
  return (
    <div className="min-h-screen bg-black text-white px-6 py-14">
      <div className="mx-auto w-full max-w-5xl">
            ...
            <label className="md:col-span-2 flex flex-col gap-2">
              ...
              <textarea
                ...
                onChange={(e) =>
                  set((p) => ({
                    ...p,
                    site: { ...p.site, bioLines: e.target.value.split("\n").map((x) => x.trim()).filter(Boolean) },
                  }))
                }
                rows={4}
                className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-sm outline-none focus:border-white/25"
        ...
        <section className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-5">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <label key={key} className="flex items-center justify-between gap-4 rounded-xl border border-white/10 bg-black/30 px-4 py-3">
            ...
            <label className="md:col-span-2 flex flex-col gap-2">
              ...
              <input
                ...
                onChange={(e) => set((p) => ({ ...p, features: { ...p.features, cheerLabel: e.target.value } }))}
                className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-sm outline-none focus:border-white/25"
              />
            </label>
            <label className="md:col-span-2 flex flex-col gap-2">
        ...
        {/* Links */}
        <section className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-5">
          <h2 className="text-sm font-semibold tracking-widest text-white/80">按鈕清單（可開關/改文字/改連結/排序）</h2>
                  ...
                  <label className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        set((p) => ({
                          ...p,
                          links: p.links.map((x, i) => (i === idx ? { ...x, badge: e.target.value || undefined } : x)),
                        }))
                      }
                      className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-sm outline-none focus:border-white/25"
                    />
                  ...
                  <label className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        set((p) => ({
                          ...p,
                          links: p.links.map((x, i) => (i === idx ? { ...x, badgeLeft: e.target.value || undefined } : x)),
                        }))
                      }
                      className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-sm outline-none focus:border-white/25"
                    />
